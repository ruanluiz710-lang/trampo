      ...
      <section style={{
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: isMobile ? '0 16px' : '0 32px', textAlign: 'center', position: 'relative', zIndex: 1 }}>
          ...
          <form onSubmit={handleSearch} style={{
            ...
            padding: '8px', boxShadow: '0 25px 50px rgba(0,0,0,0.4)',
            display: 'flex', flexDirection: isMobile ? 'column' : 'row',
            gap: isMobile ? '0' : '0', alignItems: 'stretch',
          }}>
            <div style={{ flex: '1 1 220px', display: 'flex', alignItems: 'center', padding: isMobile ? '12px 16px' : '12px 20px', borderBottom: isMobile ? '1px solid #f0f0f0' : 'none', borderRight: isMobile ? 'none' : '1px solid #f0f0f0' }}>
            ...
            <div style={{ flex: '1 1 160px', display: 'flex', alignItems: 'center', padding: isMobile ? '12px 16px' : '12px 20px', borderBottom: isMobile ? '1px solid #f0f0f0' : 'none' }}>
            ...
            <button type="submit" style={{
              backgroundColor: '#D95D39', color: '#fff', fontWeight: '700', fontSize: '15px',
              padding: isMobile ? '14px 20px' : '16px 32px',
              borderRadius: '14px', border: 'none', cursor: 'pointer', fontFamily: f,
